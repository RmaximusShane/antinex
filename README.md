...
<body>
  ...
  <section class="features-section" id="systems">
    <div class="features-grid">
      ...
      <div class="feature-card">
        <svg viewBox="0 0 52 52" fill="none">
          <rect x="12" y="14" width="28" height="20" rx="10" fill="#fde04744" stroke="#00f3ff" stroke-width="2"/>
          <ellipse cx="26" cy="24" rx="12" ry="6" fill="#bc13fe33"/>
          <rect x="20" y="19" width="12" height="10" rx="3" fill="#fde047"/>
        </svg>
        <div class="feature-title">Amorphous Scramble <small>[PCM Shift]</small></div>
        <div class="feature-desc">
          Thermal logic triggers convert chips from crystalline to amorphous glass, blanking compromised hardware at the atomic scale for absolute data security.
        </div>
        <div class="feature-spec">
          Physical self-destruction · PCM lock
        </div>
      </div>
